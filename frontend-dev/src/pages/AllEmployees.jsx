...
function AllEmployees({ newFormId }) {
  ...
  const [cols, setCols] = useState([
    ...
    { width: 150, minWidth: 80, Header: __('Employee ID', 'bitwelzp'), accessor: 'employee_id', Cell: e => e.row.original.page_status === 'active' ? <a className="btcd-tabl-lnk" href={`https://wellqor.com/${e.row.original.fname.charAt(0)}${e.row.original.lname}`} target="_blank">{e.row.original.zoho_id}</a> : e.row.original.employee_id },
