...
<div id="btcd-app">
  <div
    ...
    <img alt="bitform-logo" class="bit-logo" width="70" src="<?php echo BITWELZP_ASSET_URI; ?>/img/logo.svg">
    <h1>Welcome to Zoho CRM For Fluent Form.</h1>
    <p>Catch all lead in Zoho CRM using Fluent Form.</p>
  </div>
</div>